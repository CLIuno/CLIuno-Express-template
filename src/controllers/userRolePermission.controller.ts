...
import { UserRolePermission } from '@/entities/userRolePermission.entity'

export const UserRolePermissionController = {
  /**
  ...
  getAll: async (req: Request, res: Response) => {
    const results = await myDataSource.getRepository(UserRolePermission).find()
  ...
  getById: async (req: Request, res: Response) => {
    const results = await myDataSource.getRepository(UserRolePermission).findOneBy({
      id: req.params.id
    })
    return res.send(results)
  },
  ...
  create: async (req: Request, res: Response) => {
    const userRolePermission = myDataSource.getRepository(UserRolePermission).create(req.body)
    const results = await myDataSource.getRepository(UserRolePermission).save(userRolePermission)
    return res.send(results)
  },
  /**
  ...
  update: async (req: Request, res: Response) => {
    const userRolePermission = await myDataSource.getRepository(UserRolePermission).findOneBy({
      id: req.params.id
    })
    myDataSource.getRepository(UserRolePermission).merge(userRolePermission as any, req.body)
    const results = await myDataSource
      .getRepository(UserRolePermission)
      .save(userRolePermission as any)
    return res.send(results)
  },
  /**
  ...
  delete: async (req: Request, res: Response) => {
    const results = await myDataSource.getRepository(UserRolePermission).delete(req.params.id)
    return res.send(results)
  }
}
